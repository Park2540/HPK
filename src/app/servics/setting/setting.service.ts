...
getproblem(id: any){
  ...
  createNewlevel(form:any,time:any):Observable<any>{
    var data = new FormData();
    data.append('name',form.name);
    data.append('time',time);
    data.append('hours',form.hours)
    data.append('minutes',form.minutes)
    return this.http.post(environment.apiUrl+'/level',data)
  }
  updatelevel(id:number,form:any,time:any):Observable<any>{
    var data = new FormData();
    data.append('name',form.name);
    data.append('time',time);
    data.append('hours',form.hours)
