...
export class BuilderComponent implements OnInit {
  ...
  this.insertproblemDataform =this.fb.group({
    ...
    timebyuser : [0,Validators.required],
...
comfirm(){
  ...
  onSubmit(){
    if (this.insertproblemDataform.valid){
      var date =new Date(this.insertproblem.timebyuser).getTime()/1000
      // this.insertproblem.timebyuser=
      this.insertproblemDataform.controls['timebyuser'].setValue(date)
      console.log(this.insertproblemDataform.value)
